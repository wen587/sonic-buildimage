...
# Add Python packages as build dependencies
$(LIBSWSSCOMMON)_BUILD_DEPENDS += $(SONIC_YANG_MGMT_PY3) $(SONIC_YANG_MODELS_PY3)

# Pass absolute path to wheels while preserving PYTHON_WHEELS_PATH
$(LIBSWSSCOMMON)_BUILD_ENV += WHEELS_ROOT_DIR=$(PROJECT_ROOT)
